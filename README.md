A broker for [Impulse](https://github.com/Arson-Club/Impulse) to interact with [pufferpanel Controller](https://gitlab.com/pufferpanel-controller/pufferpanel-4) using the api
